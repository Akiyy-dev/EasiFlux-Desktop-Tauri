...
mod capability_tests {
    ...
    #[test]
    fn remove_permission_has_no_scope_and_union_has_no_fs_shell_dialog_or_remote_grant() {
        ...
        assert!(
            ...
            "plugin runtime dialog/fs/shell/opener capability found in union: {identifiers:?}"
        );
    }
}
