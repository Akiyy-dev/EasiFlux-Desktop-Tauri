...
* **plugin:** add declarative read-only commands (Phase 1D) ([a5eeabe](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/a5eeabe1f4e75f1d930327f60ca0c67d3a4bc285))
* **plugin:** add declarative read-only commands (Phase 1D) ([8194deb](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/8194deb19198a039e0d362f8e9b8f47597cb808e))
* **plugin:** add isolated native smoke host ([87caf8a](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/87caf8a80ce3fd1603901e4108e79b0f488dda47))
* **plugin:** add isolated native smoke profile ([0fea42f](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/0fea42fd505dd19833d2dec59f19c49aac777156))
...
* **plugin:** add managed package removal experience ([7bec763](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/7bec76354f5e54ca6d25d5fc3f8ff95ed19a2adc))
* **plugin:** add searchable command workbench (Phase 1E) ([fb66c67](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/fb66c6735ac00ae5f6cedf146c13ca0b6fffb7ac))
* **plugin:** add searchable installed command workbench (Phase 1E) ([5518584](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/55185841347a03b5b02ffa03ced71aac94d5ca9f))
...
* **plugin:** complete managed local removal UI and recovery ([23e8cc9](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/23e8cc9f933dabc15dcd194241e3e627ab6bd3ee))
...
* **plugin:** coordinate managed package removal state ([bf0e942](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/bf0e942ded1f0e51c9938c524775d68f19bc29ba))
* **plugin:** define managed package ownership records ([2feff6f](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/2feff6f4646fb3a8988320b8d69004d22173e14a))
...
* **plugin:** expose managed package removal command ([70e1bf8](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/70e1bf87e1ff221a83f8fbba771babfc5e26db62))
...
* **plugin:** quarantine managed packages safely ([0b02adc](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/0b02adc5dc3474b2b1fec7aecdf6a4cbeeec6f1b))
...
* **plugin:** reconcile managed ownership in catalog v3 ([f66deaa](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/f66deaa53dd9309c106122b72cc180296f467051))
* **plugin:** register ownership for new manifest imports ([e9c80d2](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/e9c80d2b532daaa6bdd085147911e029da55010f))
* **plugin:** remove managed local packages transactionally ([82fe1ed](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/82fe1ed9a67fbc3a85b6898e5d129001aa60a462))
* **plugin:** secure lifecycle document persistence ([12b93d2](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/12b93d2727c26d709ffd540634723cfd144fc569))
...
* **plugin:** validate ownership and removal protocols ([8de2704](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/8de270482d234e8a0fe5f698d0d5ae44f1202b67))


### Bug Fixes

* **ci:** restrict workflow token permissions ([42dcfea](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/42dcfea127e23f5881235b7308a2915864ca53cf))
...
* **plugin:** block lifecycle on unpublished imports ([c1effdb](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/c1effdb9bca72c39dcc8e3217ec6d0695021e7fc))
* **plugin:** block mutations until removal authority reconciles ([13e9523](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/13e952399eeab4bf702ab7751cbbb361a57623f0))
...
* **plugin:** compare dialog controls by identity ([9203c4c](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/9203c4c2f78ef83d0cf5028878d4ce3d4d4a3c87))
* **plugin:** consolidate slot occupancy evidence ([f18d662](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/f18d66258f9340886489d53b480bcfac235fb4e1))
...
* **plugin:** enforce smoke artifact boundary ([75984cf](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/75984cf0f96abb1e98ef468e156fbd46491d91db))
...
* **plugin:** guard immediate removal teardown ([d3982fe](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/d3982fe95afb138969490f480dd045efa85aeb23))
* **plugin:** harden lifecycle evidence ([fbbcab6](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/fbbcab6bf96e7287c6798fe8599d4b8c3c138e0b))
* **plugin:** isolate catalog ownership evidence ([cf01bf3](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/cf01bf3c855303246c20b720dddb8e48a52a71b9))
* **plugin:** keep submitted removal teardown focus neutral ([b9bf756](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/b9bf756c1eaf8d024f21f23a79f07f61b954b1a5))
* **plugin:** make smoke deadline independent of reporting ([d43f7ce](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/d43f7ced6a12ed153a138d5f7cb1adddf7870f0e))
...
* **plugin:** preserve snapshot on uncertain import promotion ([8c67af0](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/8c67af05e45dbe69d4095a022d72c506d741403f))
...
* **plugin:** validate held receipt before cleanup ([49d10bf](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/49d10bfe0c99747c1fe959bc37ee23f48d555250))
* **plugin:** validate ownership slot grammar ([6cba32e](https://github.com/Akiyy-dev/EasiFlux-Desktop-Tauri/commit/6cba32e5d119b5ed54341b117891b1d846346be2))
